...
import { post_accountsHandler } from "./tools/post_accounts.js";
import { get_accounts_account_idHandler } from "./tools/get_accounts_account_id.js";
import { get_accounts_account_id_balanceHandler } from "./tools/get_accounts_account_id_balance.js";
...
export function createServer(): McpServer {
  ...
  server.registerTool("post_accounts", {
    description: "Create Account",
    inputSchema: {  },
  }, post_accountsHandler);

  server.registerTool("get_accounts_account_id", {
    description: "Get Account Details",
    inputSchema: { accountId: z.string() },
  }, get_accounts_account_idHandler);

  server.registerTool("get_accounts_account_id_balance", {
    description: "Get Account Balance",
    inputSchema: { accountId: z.string() },
  }, get_accounts_account_id_balanceHandler);
  ...
  server.registerResource("get_customers_customer_id", "api:///customers/{customerId}", {
    description: "Get Customer Details",
    mimeType: "application/json",
  }, async (uri) => readUpstreamResource(uri.href));

  server.registerResource("post_accounts", "api:///accounts", {
    description: "Create Account",
    mimeType: "application/json",
  }, async (uri) => readUpstreamResource(uri.href));

  server.registerResource("get_accounts_account_id", "api:///accounts/{accountId}", {
    description: "Get Account Details",
    mimeType: "application/json",
  }, async (uri) => readUpstreamResource(uri.href));

  server.registerResource("get_accounts_account_id_balance", "api:///accounts/{accountId}/balance", {
    description: "Get Account Balance",
    mimeType: "application/json",
  }, async (uri) => readUpstreamResource(uri.href));
  ...
  server.registerResource("get_transactions_transaction_id", "api:///transactions/{transactionId}", {
    description: "Get Transaction Details",
    mimeType: "application/json",
  }, async (uri) => readUpstreamResource(uri.href));
